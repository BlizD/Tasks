...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготавливаюСтатусыЗадачУдаляяЗадачуСИменем(Парам01)","ЯПодготавливаюСтатусыЗадачУдаляяЗадачуСИменем","Допустим я подготавливаю статусы задач удаляя задачу с именем ""Тестовая111""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУдаляюЗадачуСИменемИзСправочника(Парам01,Парам02)","ЯУдаляюЗадачуСИменемИзСправочника","Допустим я удаляю задачу с именем ""Тестовая111"" из справочника ""Статусы задачи""");
...
Процедура ПередОкончаниемСценария() Экспорт
	ЭлементСправочника = утвПолучитьЭлементГруппуСправочника("узСтатусыЗадачи", , "Тестовая111", , ИСТИНА);
	УдалитьЭлементСправочника("узСтатусыЗадачи", ЭлементСправочника);
КонецПроцедуры
...
//@ЯУдаляюЗадачуСИменемИзСправочника(Парам01,Парам02)
Процедура ЯУдаляюЗадачуСИменемИзСправочника(НаименованиеЭлемента, ПредставлениеСправочника) Экспорт
