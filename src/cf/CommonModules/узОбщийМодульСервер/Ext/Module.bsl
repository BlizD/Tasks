...
Функция ГУИД_Справочник_узЗадачи() Экспорт
	Возврат Новый УникальныйИдентификатор("2174e448-406e-4b9d-b38c-ba98ab03f94b");
КонецФункции 

Функция ГУИД_Справочник_узКонтрагенты() Экспорт
	Возврат Новый УникальныйИдентификатор("1d5bdf0d-6fde-49ff-8c71-3473ff4e23d9");
КонецФункции 
