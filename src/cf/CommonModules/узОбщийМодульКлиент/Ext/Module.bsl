...
//Павлюков - 183 - перенёс из модуля приложения сюда
//чтобы стартовало после всего, что может открыть БСП при запуске
//Вызов из ОбщегоНазначенияКлиентПереопределяемый.ПослеНачалаРаботыСистемы
