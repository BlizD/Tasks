...
Процедура ПриОпределенииВозможностиОбновления(Знач ВерсияДанных) Экспорт
	...
	//	
	//	ТекстСообщения = НСтр("ru = 'Недопустимая попытка обновления с версии %2.
	...
	//	
	//	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстСообщения, ДопустимаяВерсия, ВерсияДанных);
	//	
