...
Процедура ОбновлениеНаВерсию_1_0_4_037()  Экспорт 
	
	СозданиеКонтактнаяИнформации_Контрагенты();	
	
КонецПроцедуры


// Процедура обновления ИБ для справочника видов контактной информации
Процедура СозданиеКонтактнаяИнформации_Контрагенты() Экспорт
    // Справочник "Контрагенты"
