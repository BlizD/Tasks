...
Функция ПроверитьМоиЗадачи(Сообщение)
	...
	Пока Выборка.Следующий() Цикл
		...
		ОписаниеЗадачи = "*Задача* #" + Формат(Выборка.Код,"ЧГ=") 
			+ " "                          
	...
	ТекстСообщения = Лев(ТекстСообщения, 4090) + " ...";
...
Функция ПроверитьНовыйСтатус(Сообщение, ЗадачаСсылка = Неопределено)
	...
	пНомерЗадачи = Справочники.узЗадачи.ПолучитьНомерЗадачи(ЗадачаСсылка);
	ТекстСообщения = "У задачи #" + пНомерЗадачи+ " " + ЗадачаСсылка + " установлен статус " + Сообщение.Текст;	
	узТелеграмБот.ОтправитьСообщение(ТекстСообщения, Сообщение.Пользователь);	
...
Функция ПроверитьНовогоИсполнителя(Сообщение, ЗадачаСсылка = Неопределено)
	...
	пНомерЗадачи = Справочники.узЗадачи.ПолучитьНомерЗадачи(ЗадачаСсылка);
	ТекстСообщения = "У задачи #" + пНомерЗадачи+ " " + ЗадачаСсылка + " установлен исполнитель " + Сообщение.Текст;	
	узТелеграмБот.ОтправитьСообщение(ТекстСообщения, Сообщение.Пользователь);	
...
Функция ПроверитьНовуюЗадачу(Сообщение, ЗадачаСсылка = Неопределено)
	...
	ТекстСообщения = НСтр("ru = 'Добавлена новая задача #%1 %2 %3'");
