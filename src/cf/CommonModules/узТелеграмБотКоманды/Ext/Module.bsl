...
Функция ДоступныеКоманды()
	...
	ДоступныеКоманды.Добавить("/МоиЗадачи - проверить все задачи в работе кроме статуса Готово");
...
Функция ПроверитьМоиЗадачи(Сообщение)
	...
	ИмяИсполнителя = СокрЛП(Сред(СокрЛ(Сообщение.Текст), 12));
	...
	Иначе
		Запрос.Текст = СтрЗаменить(
			Запрос.Текст, "И узЗадачи.Исполнитель.Наименование = &Исполнитель", "");
	КонецЕсли;
