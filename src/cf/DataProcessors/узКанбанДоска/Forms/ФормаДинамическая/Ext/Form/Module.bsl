...
Функция ПроверитьЗаполнениеЦвета(ТекЦвет)
	Если ТекЦвет = Неопределено ИЛИ ТекЦвет = ЦветаСтиляузКанбанДоскаЦветЧерныйНаСервере() Тогда
		Возврат ЛОЖЬ;
	Иначе
		Возврат ИСТИНА;
	КонецЕсли;
...
Функция ЦветаСтиляузКанбанДоскаЦветЧерныйНаСервере()
	Возврат ЦветаСтиля.узКанбанДоскаЦветЧерный;	
КонецФункции 
