...
&НаСервереБезКонтекста
Функция ПользовательДляСохраненияВариантаКанбанДоски(ЗНАЧ ПользовательИБ = Неопределено)
...
Процедура ОбновитьЗаголовокФормыНаКлиенте(Вариант)
	...
	ТекстЗаголовока = НСтр("ru = 'Канбан доска: %1 '; en = 'Kanban board: %1 '; ro = 'Placă Kanban: %1 '");
...
// [+] #283 Мальков М.В. 2023-01-30	
// ПолучитьВыборкуВсеПользователи 
//
