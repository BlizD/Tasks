...
Процедура ЗаполнитьТЧНастройкиКолонок()Экспорт
	...
	|ГДЕ
<<<<<<< HEAD:src/cf/DataProcessors/узКанбанДоска/Ext/ObjectModule.bsl
	|	узСтатусыЗадачи.Предопределенный	
=======
	|	узСтатусыЗадачи.Предопределенный
>>>>>>> 9de13140c465c87a3651a9ffc225d11e59550f3a:src/cf/DataProcessors/узКанбанДоска/Ext/ObjectModule.bsl
	|
	|УПОРЯДОЧИТЬ ПО
