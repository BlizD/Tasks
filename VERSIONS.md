...
**Выпущена версия 2026.09.06.1 (Обновление от 06.09.2026)**
...
**Выпущена версия 2025.10.19.1 (Обновление от 19.10.2025)**

**Изменения**

* #358 Не открывается канбан доска при смене языка интерфейса. Спасибо @RuDaVa
* #361 При создании задачи ошибка связанная с RLS. Спасибо @7OH
* #362 Метод ОбновитьКонтактнуюИнформацию на форме узКонтрагенты необходимо сделать экспортным. Спасибо @OLEG-LV
* #363 Доработка видимости вкладок продолжение задачи "Скрывать дополнительные страницы в задаче (скрытие, показ)" 
* #364 Добавление телеграмм бота в групповой чат. Спасибо [@ЭдуардСуровый](https://t.me/Osmium90)
* #365 Новые команды телеграмм бота (мои задачи, указание исполнителя для задач, изменить статус задачи). Спасибо [@ЭдуардСуровый](https://t.me/Osmium90)
* #366 Хештег задачи для уведомлений в телеграмме. Спасибо [@ЭдуардСуровый](https://t.me/Osmium90)
* #367 Не отправляются уведомления в телеграмм содержащие спец символы
...
* #357 Дополнительный реквизит не формируется в закладке "дополнительно" справочника Задачи 

**Выпущена версия 2025.02.23.1 (Обновление от 23.02.2025)**

**Изменения**

* #352 Скрывать дополнительные страницы в задаче (скрытие, показ) (рис.1)
* #348 При добавлении задачи выходит ошибка прав доступа для пользователя с правами (RLS) 
* #349 При открытии канбан доски выдается ошибка прав доступа для пользователя (RLS)
* #347 При чтении сохраненных вариантов под обычным пользователем, выдается ошибка.
* #355 При создании задачи из Телеграмм указывать ПоказыватьВОтчетахИКанбанДоске = ДА. Чтобы сразу отображалась на канбан доске.
...
_**ВНИМАНИЕ! Пропадут сохраненные варианты для Канбан доски, для тех пользователей у которых ИмяПользователяИБ отличается от ФИО Пользователя**_

**Инструкции**

[Как настроить рассылку отчета о просроченных задачах (рис. 2)](https://github.com/BlizD/Tasks/wiki/%D0%9A%D0%B0%D0%BA-%D0%BD%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%B8%D1%82%D1%8C-%D1%80%D0%B0%D1%81%D1%81%D1%8B%D0%BB%D0%BA%D1%83-%D0%BE%D1%82%D1%87%D0%B5%D1%82%D0%B0-%D0%BE-%D0%BF%D1%80%D0%BE%D1%81%D1%80%D0%BE%D1%87%D0%B5%D0%BD%D0%BD%D1%8B%D1%85-%D0%B7%D0%B0%D0%B4%D0%B0%D1%87%D0%B0%D1%85)

Рис. 1 
![CollapsibleGroups_ver2](https://github.com/user-attachments/assets/d8df29f9-7295-46c7-ace9-6a5b4d438e24)
Рис. 2
![image](https://github.com/user-attachments/assets/c708e189-bee9-4e64-9fcf-0d8c82e00b24)
