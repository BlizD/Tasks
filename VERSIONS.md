**Выпущена версия 1.0.5.xxx (Обновление от xx.xx.xxxx)**
...
* [Кейс: как можно настроить уведомления о задаче пришедшей из почты](https://github.com/BlizD/Tasks/wiki/Кейс:-как-можно-настроить-уведомления-о-задаче-пришедшей-из-почты.)
