**Выпущена версия 1.0.5.ххх (Обновление от хх.хх.хххх)**
Тест
...
**Сценарий работы:**
1. По кнопке "Получить шаблон Excel" открывается табличный документ, сохраняем его в Excel. Далее заполняем его;
2. В обработке в поле "Имя файла" указываем сохраненный файл Excel на предыдущем этапе и жмем "Прочитать файл";
3. Далее жмем "Создать задачи" - будут созданы новые задачи.

![image](https://user-images.githubusercontent.com/10989306/117636932-fb51a580-b189-11eb-98c0-1fa83e6297b3.png)
