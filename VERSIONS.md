...
* @serg33rus #277 Переход по ссылкам в форматированном тексте содержания задачи. 
Теперь для существующих задач содержание (форматированный текст) открывается в режиме только просмотр.
Такое поведение можно регулировать с помощью константы "Устанавливать только просмотр для содержания у существующих задач" = Да/Нет
